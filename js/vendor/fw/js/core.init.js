...
function melodyschool_ready_actions() {
	...
	jQuery('.woocommerce,.woocommerce-page').on('click', '.mode_buttons a', function(e) {
		...
		jQuery.cookie('melodyschool_shop_mode', mode, {expires: 365, path: '/'});
		...
		rules: [
			{
				...
				max_length: { value: MELODYSCHOOL_STORAGE['comments_maxlength'], message: MELODYSCHOOL_STORAGE['strings']['text_long']}
			}
		]
	};
...
function melodyschool_login_validate(form) {
	...
	var error = melodyschool_form_validate(form, {
		...
		rules: [
			{
				field: "log",
				min_length: { value: 1, message: MELODYSCHOOL_STORAGE['strings']['login_empty'] },
				max_length: { value: 60, message: MELODYSCHOOL_STORAGE['strings']['login_long'] }
			},
			{
				field: "pwd",
				min_length: { value: 4, message: MELODYSCHOOL_STORAGE['strings']['password_empty'] },
				max_length: { value: 30, message: MELODYSCHOOL_STORAGE['strings']['password_long'] }
			}
		]
	});
	if (!error) {
	...
	var error = melodyschool_form_validate(form, {
		...
		rules: [
			...
			},
			{
				...
				equal_to: { value: 'registration_pwd', message: MELODYSCHOOL_STORAGE['strings']['password_not_equal'] }
			}
		]
	});
	if (!error) {
